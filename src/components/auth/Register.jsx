...
export const Register = ({setUser}) => {
  ...
  return (
    <section className="columns is-centered">
      ...
      <h1 className="title">Howdy, Neighbor!</h1>
        ...
        <div className="field">
          ...
          <div className="control">
            <input className="input" type="text" ref={address} />
          </div>
        </div>
        ...
        <div className="field">
          ...
          <div className="control">
            <textarea className="input" placeholder="http://www.image.com" ref={profile_image}></textarea>
          </div>
        </div>
